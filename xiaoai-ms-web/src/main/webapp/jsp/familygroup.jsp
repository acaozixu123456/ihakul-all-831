		...
		<form action="${pageContext.request.contextPath }/showAllFanily.action?pageNow=1&showPage=5" method="post">
			...
			<table class="table mt_20">
				...
				<tr>
					...
					<td>${fa.city }${fa.district }</td>
					<td><a href="${pageContext.request.contextPath }/selectFami.action?id=${fa.groupId }" class="operate">修改</a><a href="#" onclick="shanchu(${fa.groupId})" class="operate">删除</a></td>
				</tr>
			...
			<div id="echart1" style="width: 100%;height:500px;display: none"></div>
			<div class="btn_submit mt_20" onclick='showChart("${pageContext.request.contextPath }")'>渲染小i分布图</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/hakuFamilyGroupEchart/echartFamilyGroup.js"></script>
<%--echart图表--%>
