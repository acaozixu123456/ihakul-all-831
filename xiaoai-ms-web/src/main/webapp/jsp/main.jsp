...
<div class="menu">
	<ul>
		...
		<li id="l6"><a href="${pageContext.request.contextPath }/showXiaolog.action?pageNow=1&showPage=5" target="content_frame">小i数据管理</a></li>
		<li id="l7"><a href="${pageContext.request.contextPath }/findVersion.action?pageNow=1&showPage=5" target="content_frame">版本管理</a></li>
		<li id="l8"><a href="${pageContext.request.contextPath }/queryHouseUser.action" target="content_frame">数据查看</a></li>
		...
		<li id="l10"><a href="${pageContext.request.contextPath }/preInitMac.action?pageNow=1&showPage=5" target="content_frame">设备MAC</a></li>
	</ul>
</div>
	
<div class="main_box">
	<div class="main">
		<iframe width="100%" height="100%" frameborder="0" id="content_frame" name="content_frame" scrolling="auto" src="${pageContext.request.contextPath }/showAllAdminAction.action?pageNow=1&showPage=5" ></iframe>
	</div>
</div>
